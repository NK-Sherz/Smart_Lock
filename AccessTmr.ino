/*******************************************************************************
* File Name: AccessTmr.ino
*
* Description: This file contains functions that track the length of time 
* messages are displayed on the LCD, the solenoid is high, length of 
* time since previous failed attempts etc. and changes status of the devices
* accordingly
...
*Purpose of Function: Tracks number of failed entries
*************************************************************/
